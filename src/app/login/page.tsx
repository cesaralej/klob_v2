...
export default function LoginPage() {
  ...
  */
  ...
  return (
    <div className="flex min-h-screen w-full flex-col items-center justify-center bg-gray-50 dark:bg-gray-900 px-4">
      <div className="mb-8 flex flex-col items-center gap-2">
        <Link href="/" className="text-3xl font-bold tracking-tight hover:text-primary transition-colors">
          KLOB
        </Link>
        <Link 
          href="/" 
